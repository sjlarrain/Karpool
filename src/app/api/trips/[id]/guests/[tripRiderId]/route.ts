...
//
// D-61: also open after departure, until the end of that day. A guest can't be charged for not
// showing (no profile), so freeing their seat — and with it the driver's pay for it — is the
// guest's version of a no-show.
